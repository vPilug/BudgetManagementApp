...
<div style="display: flex; flex-direction: column; justify-content: space-between;">
    <div style="padding: 20px 0; background-color: #D1FBED;"> <%-- START HEADER --%>
        <div style=" display: flex; width: 65%; margin: 0 auto;">
            ...
            <div style="width: 42%; display: flex; justify-content: space-between; align-items: flex-end;"> <%-- Main Buttons div --%>
                ...
                <div class="dropdown">
                    <button class="btn dropdown-toggle btn-lg" type="button"
                            style="background-color: #486976; color: #fff;"
                ...
                <div class="dropdown">
                    <button class="btn dropdown-toggle btn-lg" style="background-color: #486976; color: #fff;"
                            type="button"
                            data-bs-toggle="dropdown"
                            aria-expanded="false">
                        Add transaction
    ...
    <%-- END HEADER --%>
    <div style="width: 65%; margin: 0 auto; padding: 50px 0; min-height: 81.5vh"> <%-- START CONTENT --%>
        <c:if test="${requestScope.error != null}">
            <div class="alert alert-danger" role="alert">
                <c:out value="${requestScope.error}"/>
            </div>
        </c:if>
        <form method="post" action="<c:out value="${context}"/>/manage-incomes">
        ...
        <table class="table table-striped table-hover" style="margin-top: 40px">
            ...
            <c:forEach items="${requestScope.incomesList}" var="income">
                <tr style="background-color:#f7fffc" id="incomesTableBody">
                    ...
                    <td>
                        <c:if test="${income.id != null}">
                            ...
                            <button data-bs-toggle="modal"
                                    data-bs-target="#exampleModal<c:out value="${income.id}"/>"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal<c:out value="${income.id}"/>" tabindex="-1"
