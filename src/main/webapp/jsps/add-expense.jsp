...
<form method="post" action="<c:out value="${context}"/>/add-expense">
  <fieldset enable>
    ...
    <div class="mb-3">
      ...
      <input type="date" id="date" class="form-control" name="date" value="<c:out value="${requestScope.expense.date}"/>">
    </div>
    <div class="mb-3">
      <label for="amount" class="form-label">Amount</label>
      <input type="number" step="0.01" id="amount" class="form-control" placeholder="100.00" name="amount" value="<c:out value="${requestScope.expense.amount}"/>">
    </div>
    <div class="mb-3">
      <label for="description" class="form-label">Description</label>
      <input type="text" id="description" class="form-control" placeholder="Expense description" name="description" value="<c:out value="${requestScope.expense.description}"/>">
    </div>
    <div class="mb-3">
